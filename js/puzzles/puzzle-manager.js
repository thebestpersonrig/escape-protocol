...
const PUZZLE_NAMES = {
  ...
  'bw-power-wires':     'Frequency Calibration',
  ...
  'ms-nav-terminal':     'Navigation Override',
...
const PUZZLE_MODULES = {
  ...
  'bw-power-wires':     () => import('./frequency-tuner.js'),
  ...
  'ms-nav-terminal':     () => import('./switch-circuit.js'),

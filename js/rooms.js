...
export class RoomRenderer {
  ...
  _getItemInnerHTML(item) {
    const ITEM_SVGS = {
      ...
      // Blackwood inspectable items
      'bw-intake-log':     `<div style="width:100%;height:100%;background:#1a1408;border:1px solid rgba(160,120,50,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-2deg);"><span style="color:rgba(180,140,60,0.7);font-size:1vw;">📒</span></div>`,
      'bw-memo':           `<div style="width:100%;height:100%;background:#141008;border:1px solid rgba(140,110,50,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(1deg);"><span style="color:rgba(160,130,60,0.7);font-size:1vw;">📋</span></div>`,
      'bw-desk-journal':   `<div style="width:100%;height:100%;background:#1c1208;border:1px solid rgba(180,120,40,0.5);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-1deg);box-shadow:2px 2px 6px rgba(0,0,0,0.5);"><span style="color:rgba(200,150,60,0.8);font-size:1vw;">📓</span></div>`,
      'bw-bells-note':     `<div style="width:100%;height:100%;background:#14120e;border:1px solid rgba(140,130,100,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(2deg);"><span style="color:rgba(180,170,130,0.7);font-size:1vw;">📝</span></div>`,
      'bw-harlan-memo':    `<div style="width:100%;height:100%;background:#181208;border:1px solid rgba(200,150,60,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-1deg);"><span style="color:rgba(200,150,60,0.7);font-size:0.9vw;">📜</span></div>`,
      'bw-incident-report':`<div style="width:100%;height:100%;background:#160a08;border:1px solid rgba(180,60,40,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(1deg);"><span style="color:rgba(200,80,60,0.7);font-size:0.9vw;">📄</span></div>`,
      'bw-cipher-key':     `<div style="width:100%;height:100%;background:#101418;border:1px solid rgba(100,140,180,0.5);border-radius:3px;display:flex;align-items:center;justify-content:center;box-shadow:0 0 4px rgba(100,140,180,0.2);"><span style="color:rgba(120,160,200,0.8);font-size:0.8vw;font-family:monospace;">✡✦☽</span></div>`,
      'bw-treatment-note': `<div style="width:100%;height:100%;background:#140c08;border:1px solid rgba(160,100,50,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-3deg);"><span style="color:rgba(180,130,60,0.7);font-size:1vw;">📝</span></div>`,
      'bw-patient-file':   `<div style="width:100%;height:100%;background:#0e0a08;border:1px solid rgba(140,80,40,0.5);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(2deg);box-shadow:2px 2px 4px rgba(0,0,0,0.5);"><span style="color:rgba(180,100,50,0.8);font-size:0.9vw;">📁</span></div>`,
      ...
      // Meridian inspectable items
      'ms-emergency-card':    `<div style="width:100%;height:100%;background:#0a1018;border:1px solid rgba(60,120,200,0.5);border-radius:3px;display:flex;align-items:center;justify-content:center;box-shadow:0 0 4px rgba(60,120,200,0.2);"><span style="color:rgba(80,150,255,0.8);font-size:0.8vw;font-family:monospace;">EMRG</span></div>`,
      'ms-oxygen-meter':      `<div style="width:100%;height:100%;background:#020c08;border:1px solid rgba(0,200,80,0.5);border-radius:3px;display:flex;align-items:center;justify-content:center;box-shadow:0 0 6px rgba(0,200,80,0.2);"><span style="color:rgba(0,220,100,0.8);font-size:0.9vw;font-family:monospace;">O₂</span></div>`,
      'ms-freight-note':      `<div style="width:100%;height:100%;background:#0a0c08;border:1px solid rgba(120,140,80,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-1deg);"><span style="color:rgba(140,160,100,0.7);font-size:1vw;">📋</span></div>`,
      'ms-captain-log':       `<div style="width:100%;height:100%;background:#020a18;border:1px solid rgba(40,100,200,0.5);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(-2deg);box-shadow:2px 2px 6px rgba(0,0,0,0.5);"><span style="color:rgba(60,140,255,0.8);font-size:1vw;">📓</span></div>`,
      'ms-beacon-manual':     `<div style="width:100%;height:100%;background:#0c0a04;border:1px solid rgba(200,160,40,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(1deg);"><span style="color:rgba(220,180,60,0.7);font-size:1vw;">📡</span></div>`,
      'ms-personal-photo':    `<div style="width:100%;height:100%;background:#181614;border:1px solid rgba(160,140,120,0.5);border-radius:2px;display:flex;align-items:center;justify-content:center;box-shadow:2px 2px 4px rgba(0,0,0,0.5);"><span style="font-size:1.2vw;">📷</span></div>`,
      'ms-safety-manual':     `<div style="width:100%;height:100%;background:#180404;border:1px solid rgba(200,40,30,0.5);border-radius:2px;display:flex;align-items:center;justify-content:center;box-shadow:0 0 4px rgba(200,40,30,0.2);"><span style="color:rgba(220,60,40,0.8);font-size:0.8vw;font-family:monospace;">⚠️</span></div>`,
      'ms-station-schematics':`<div style="width:100%;height:100%;background:#040a14;border:1px solid rgba(0,120,200,0.4);border-radius:2px;display:flex;align-items:center;justify-content:center;transform:rotate(2deg);"><span style="color:rgba(0,150,220,0.7);font-size:1vw;">📐</span></div>`,
    };
